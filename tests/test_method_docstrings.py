...
def test_model_method_display(app, do_autodoc):
    ...
    assert list(actual) == [
        ...
        "",
        "   Shows the label of the :attr:`dummy_field`. "
        "See :meth:`~django.db.models.Model.get_FOO_display` for more information.",
        "",
    ]
...
def test_model_method_get_next_by(app, do_autodoc):
    ...
    assert list(actual) == [
        ...
        "   :module: dummy_django_app.models",
        "",
        "   Finds next instance based on :attr:`dummy_field`. "
        "See :meth:`~django.db.models.Model.get_next_by_FOO` for more information.",
        "",
    ]
...
def test_model_method_get_previous_by(app, do_autodoc):
    ...
    assert list(actual) == [
        ...
        "   :module: dummy_django_app.models",
        "",
        "   Finds previous instance based on :attr:`dummy_field`. "
        "See :meth:`~django.db.models.Model.get_previous_by_FOO` for more information.",
        "",
    ]
